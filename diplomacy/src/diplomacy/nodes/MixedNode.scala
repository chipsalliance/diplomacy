...
/** [[Dangle]] captures the `IO` information of a [[LazyModule]] and which two [[BaseNode]]s the [[Edges]]/[[Bundle]] connects.
  ...
  * using [[diplomacy.nodes.MixedNode.danglesOut]] and [[diplomacy.nodes.MixedNode.danglesIn]] ,
...
private[diplomacy] abstract class MixedNode[DI, UI, EI, BI <: Data, DO, UO, EO, BO <: Data](
  ...
  def inputs: Seq[(OutwardNode[DI, UI, BI], RenderedEdge)] = (iPorts.zip(edgesIn)).map {
    case ((_, n, p, _), e) =>
