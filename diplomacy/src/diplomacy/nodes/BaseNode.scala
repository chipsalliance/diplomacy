...
import diplomacy.{sourceLine, ValName}
...
trait InwardNode[DI, UI, BI <: Data] extends BaseNode {
  ...
  /** Accessor for [[diParams]]. */
  def getDiParams = diParams

  /** Accessor for [[uiParams]]. */
  def getUiParams = uiParams
...
trait OutwardNode[DO, UO, BO <: Data] extends BaseNode {
  ...
  /** Accessor for [[uoParams]]. */
  def getUoParams = uoParams

  /** Accessor for [[doParams]]. */
  def getDoParams = doParams
